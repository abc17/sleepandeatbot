...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = """
👶 Привет! Я бот для анализа режима сна и кормления малыша.

📋 Что я умею:
• Анализировать JSON файлы экспорта чатов Telegram
• Находить записи о сне (формат "09:30–11:00 сон")  
• Находить записи о кормлении (формат "14:20 смесь 80")
• Строить графики режима дня и статистики

📎 Просто отправьте мне JSON файл с экспортом чата, и я создам для вас наглядные графики!
...
1️⃣ Экспортируйте чат Telegram в JSON формате
2️⃣ Отправьте файл боту
3️⃣ Получите два графика:
